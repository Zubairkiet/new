...
public void policearea()
    ...
    System.out.println("Press 1 for View complains, 2 for Actions, 3 for News 4 for Questions, 5 for Emergency, 6 for Challan, 7 for Crime Record!");
...
System.out.println("Enter criminal record ");
   String cha;
    ...
    try {
                this.fw = new FileWriter("crrecord.txt",true);
